...
from ToyTrajectoryNet.models import ToyModel, make_model
from ToyTrajectoryNet.plots import plot_comparision, plot_losses
from ToyTrajectoryNet.train import train, train_emd
...
from ToyTrajectoryNet.geo import GeoEmbedding, DiffusionDistance
...
ToyTrajectoryNet.models. However, this script is easily adapted to handle 
