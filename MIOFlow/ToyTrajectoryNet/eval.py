# AUTOGENERATED! DO NOT EDIT! File to edit: 10_eval.ipynb (unless otherwise specified).

__all__ = ['generate_points', 'generate_trajectories', 'generate_plot_data', 'get_points_from_trajectories',
           'calculate_nn', 'generate_tjnet_trajectories', 'get_cell_indexes']
...
def generate_points(
    ...
    if autoencoder is not None and recon:
        #print(type(data_t0), data_t0.shape)
